    ...
    <D as strum::IntoDiscriminant>::Discriminant: std::convert::AsRef<str>,
{
    ...
    pub fn open_tree<M>(&self) -> MemoryStoreTree<D, M>
    where
...
pub struct MemoryStoreTree<D, M>
where
    D: NetabaseDefinitionTrait,
...
impl<D, M> NetabaseTreeSync<D, M> for MemoryStoreTree<D, M>
where
...
impl<D, M> crate::traits::store_ops::StoreOps<D, M> for MemoryStoreTree<D, M>
where
    D: NetabaseDefinitionTrait + TryFrom<M> + ToIVec + From<M>,
...
impl<D, M> crate::traits::store_ops::StoreOpsSecondary<D, M> for MemoryStoreTree<D, M>
where
    D: NetabaseDefinitionTrait + TryFrom<M> + ToIVec + From<M>,
    M: NetabaseModelTrait<D> + TryFrom<D> + Into<D> + Clone + bincode::Decode<()>,
    M::PrimaryKey: bincode::Decode<()> + Clone,
