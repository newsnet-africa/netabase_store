...
use crate::traits::subscription::Subscriptions;
...
// Note: SubscriptionTree implementation is now generated by the streams macro
// This allows for proper const TOPIC values for each topic variant
...
// Note: OpenSubscriptionTree implementation will be generated by the streams macro
// This allows for proper type-safe subscription tree handling per topic
