...
use redb::{TransactionError, ReadableDatabase};
...
pub use self::tables::{ModelOpenTables, TablePermission, TableType, ReadWriteTableType};
    ...
    D: Clone,
{
    ...
    pub fn prepare_model<'txn, 'data, M>(&'txn self) -> NetabaseResult<ModelOpenTables<'txn, 'data, D, M>>
    where
    ...
    pub fn read_redb<'data, M>(&'db self, key: &<M::Keys as NetabaseModelKeys<D, M>>::Primary<'data>) -> NetabaseResult<Option<M>>
    where
        M: RedbModelCrud<'db, 'data, D> + RedbNetbaseModel<'data, D> + Clone + std::borrow::Borrow<<M as redb::Value>::SelfType<'data>> + redb::Value<SelfType<'data> = M>,
        <<M as NetabaseModel<D>>::Keys as NetabaseModelKeys<D, M>>::Primary<'data>: Clone,
        <<M as NetabaseModel<D>>::Keys as NetabaseModelKeys<D, M>>::Secondary<'data>: Clone,
    ...
    pub fn update_redb<'data, M>(&'db self, model: &'data M) -> NetabaseResult<()>
    where
        M: RedbModelCrud<'db, 'data, D> + RedbNetbaseModel<'data, D> + Clone + std::borrow::Borrow<<M as redb::Value>::SelfType<'data>> + redb::Value<SelfType<'data> = M>,
        <<M as NetabaseModel<D>>::Keys as NetabaseModelKeys<D, M>>::Primary<'data>: Clone,
        <<M as NetabaseModel<D>>::Keys as NetabaseModelKeys<D, M>>::Secondary<'data>: Clone,
    ...
    pub fn delete_redb<'data, M>(&'db self, key: &<M::Keys as NetabaseModelKeys<D, M>>::Primary<'data>) -> NetabaseResult<()>
    where
        M: RedbModelCrud<'db, 'data, D> + RedbNetbaseModel<'data, D> + Clone + std::borrow::Borrow<<M as redb::Value>::SelfType<'data>> + redb::Value<SelfType<'data> = M>,
        <<M as NetabaseModel<D>>::Keys as NetabaseModelKeys<D, M>>::Primary<'data>: Clone,
        <<M as NetabaseModel<D>>::Keys as NetabaseModelKeys<D, M>>::Secondary<'data>: Clone,
