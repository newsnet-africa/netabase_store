...
//! - Subscription tables map Topic → [Primary Keys] (multimap)
//!
//! # Use Cases
//!
...
//! ```
//!
//! See [`subscription`](crate::traits::registery::definition::subscription) module for details.
//!
//! # Performance
//!
...
///
/// Generated by the `#[derive(NetabaseModel)]` macro when using `#[subscribe(...)]`.
/// The macro creates conversions between model subscriptions and definition subscriptions.
///
/// See [`subscription`](crate::traits::registery::definition::subscription) module for details.
