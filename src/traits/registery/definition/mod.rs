...
///
/// ```rust
/// // Conceptual structure - generated by macro
/// # use serde::{Serialize, Deserialize};
...
/// # Usage
///
/// Tree names are used internally by the database layer to access specific tables.
...
///
/// Keys are used internally to manage relationships between models.
///
