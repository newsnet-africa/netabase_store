...
where
    ...
    <<Self as NetabaseDefinitionTraitKey>::Definition as IntoDiscriminant>::Discriminant:
        AsRef<str>
            + Clone
            + Copy
            + std::fmt::Debug
            ...
            + 'static
            + FromStr,
    <<Self as NetabaseDefinitionTraitKey>::Definition as strum::IntoDiscriminant>::Discriminant:
        std::marker::Copy,
    <<Self as NetabaseDefinitionTraitKey>::Definition as strum::IntoDiscriminant>::Discriminant:
        std::fmt::Debug,
    <<Self as NetabaseDefinitionTraitKey>::Definition as strum::IntoDiscriminant>::Discriminant:
