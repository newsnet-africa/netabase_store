//! Capability-based access control for Netabase operations.
//!
//! This module provides types for implementing capability-based security
//! in the Netabase protocol. Capabilities define what operations a peer
//! can perform on specific data ranges.
//!
//! # Key Types
//!
//! - `PathRange`: Defines ranges of keys a capability applies to
//! - `Capability`: Represents granted access rights
//! - `CapabilityExpiration`: Timestamp for capability expiration
//!
//! # Security Model
//!
//! Capabilities are cryptographically signed and can be delegated.
//! They specify:
//! - The operations allowed (read, write, delete)
...
use crate::primitives::{Operation, Signature};
