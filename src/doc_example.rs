...
///
/// Note: The netabase_networking macro is not used here as the doc_example
/// is designed to be a minimal, self-contained example for documentation.
/// Networking capabilities are demonstrated in separate examples.
