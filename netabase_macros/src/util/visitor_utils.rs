use syn::{Attribute, Fields, ItemStruct, Meta, Path, PathSegment, Token, punctuated::Punctuated};

use crate::{
    errors::{LinkPathError, NetabaseModelDeriveError},
    item_info::netabase_model::{ModelKeyInfo, ModelLinkInfo},
    util::field_is_attribute,
    visitors::{definitions_visitor::DefinitionsVisitor, model_visitor::ModelVisitor},
};
