...
/// # struct UserBorrowed;
/// // Added field (when redb-zerocopy feature is enabled):
/// #[cfg(feature = "redb-zerocopy")]
/// # struct User {
/// _borrowed_ref: OnceCell<UserBorrowed>
/// # }
/// ```
///
/// And generates:
...
/// ## 1. Definition Enum
/// ```
/// # use strum::{EnumDiscriminants, IntoStaticStr, EnumIter, Display, AsRefStr, EnumString};
...
/// ```
/// # use strum::{EnumIter, Display, AsRefStr, EnumString};
/// // Generated by strum:
...
/// # enum UserKey { Primary(UserPrimaryKey) }
/// # #[derive(Clone, Debug, PartialEq, Eq, Hash, bincode::Encode, bincode::Decode)]
/// # struct UserPrimaryKey(u64);
/// # #[derive(Clone, Debug, PartialEq, Eq, Hash, bincode::Encode, bincode::Decode)]
/// # enum PostKey { Primary(PostPrimaryKey) }
/// # #[derive(Clone, Debug, PartialEq, Eq, Hash, bincode::Encode, bincode::Decode)]
/// # struct PostPrimaryKey(String);
/// // The macro generates:
/// #[derive(Clone, Debug, PartialEq, Eq, bincode::Encode, bincode::Decode)]
...
/// # struct BincodeWrapper<T>(T);
/// # struct CompositeKey<T1, T2>(T1, T2);
/// # struct UserPrimaryKey(u64);
/// # struct User { id: u64 }
/// # struct PostPrimaryKey(String);
/// # struct Post { id: String }
/// # type UserSecondaryKeys = ();
/// # type PostSecondaryKeys = ();
/// // The macro generates (conceptual - actual types are more complex):
/// pub struct BlogSchemaTables {
///     pub user: TableDefinition<'static, BincodeWrapper<UserPrimaryKey>, BincodeWrapper<User>>,
///     pub user_secondary: MultimapTableDefinition<'static, BincodeWrapper<CompositeKey<UserSecondaryKeys, UserPrimaryKey>>, ()>,
///     pub post: TableDefinition<'static, BincodeWrapper<PostPrimaryKey>, BincodeWrapper<Post>>,
///     pub post_secondary: MultimapTableDefinition<'static, BincodeWrapper<CompositeKey<PostSecondaryKeys, PostPrimaryKey>>, ()>,
/// }
/// ```
...
/// # struct BlogSchema;
/// # struct BlogKeys;
/// # struct BlogSchemaDiscriminant;
/// # struct BlogSchemaTables;
/// // The macro generates:
...
/// ## 6. Conversion Traits
/// ```
/// # #[derive(Clone)] struct User { id: u64 }
/// # #[derive(Clone)] struct Post { id: String }
/// # #[derive(Clone)] enum BlogSchema { User(User), Post(Post) }
/// // The macro generates:
...
/// #   #[derive(NetabaseModel, Clone, bincode::Encode, bincode::Decode)]
/// #   #[netabase(BlogSchema)]
/// #   pub struct Post { #[primary_key] pub id: String, pub title: String }
/// # }
/// # use blog::*;
/// # let store = SledStore::<BlogSchema>::new("./blog.db")?;
...
///
/// users.put(User { id: 1, name: "Alice".into() })?;
/// posts.put(Post { id: "post-1".into(), title: "First Post".into() })?;
/// # Ok::<(), Box<dyn std::error::Error>>(())
/// ```
///
...
/// let user: User = item.try_into().unwrap();
/// ```
///
/// # Troubleshooting
///
