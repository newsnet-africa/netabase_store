...
impl<'a> DefinitionsVisitor<'a> {
    ...
    pub fn generate_definition_trait_impls(
        ...
        let helper_functions = crate::generators::record_store::generate_helper_functions(definition);
        ...
        let record_store_methods = crate::generators::record_store::generate_trait_methods(&self.modules, definition);
    ...
    pub fn generate_enums(
        ...
        let mut def_enum: ItemEnum = parse_quote! {
            ...
            #[strum_discriminants(derive(Hash,
                ::netabase_deps::strum::EnumIter, ::netabase_deps::strum::EnumString,
        ...
        let mut def_key_enum: ItemEnum = parse_quote! {
            ...
            #[strum_discriminants(derive(Hash,
                ::netabase_deps::strum::EnumString,
