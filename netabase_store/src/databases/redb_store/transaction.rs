    ...
    <D as NetabaseDefinitionTrait>::Keys: IntoDiscriminant,
{
    ...
    fn process_queue(&mut self) -> NetabaseResult<()> {
        ...
        debug!("RedbWriteTransaction: Processing queue with {} operations", ops_count);
        ...
        trace!("  Applied all operations in {:?}", apply_start.elapsed());
    ...
    <D as NetabaseDefinitionTrait>::Keys: IntoDiscriminant,
{
    ...
    fn commit(mut self) -> NetabaseResult<()> {
        ...
        trace!("  Committed DB in {:?}", flush_start.elapsed());
        debug!("RedbWriteTransaction: Completed in {:?}", start.elapsed());
