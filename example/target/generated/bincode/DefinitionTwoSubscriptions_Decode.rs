...
DefinitionTwoSubscriptions
{
    ...
    error :: DecodeError >
    {
        ...
        {
            0u32 =>core :: result :: Result :: Ok(Self ::General {}), variant
            =>core :: result :: Result ::
            Err(:: bincode :: error :: DecodeError :: UnexpectedVariant
            {
                found : variant, type_name : "DefinitionTwoSubscriptions",
...
for DefinitionTwoSubscriptions
{
